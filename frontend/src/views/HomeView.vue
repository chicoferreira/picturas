...
<template>
  <div class="min-h-screen bg-[#030712] text-white relative overflow-hidden">
    ...
    <div class="container relative z-10 flex flex-col items-center justify-center min-h-screen px-4">
      <div class="text-center mb-8">
        <h1 class="text-5xl font-bold mb-2 bg-gradient-to-r from-[#6D28D9] to-white bg-clip-text text-transparent tracking-tight">Welcome to PictuRAS</h1>
        <p class="text-xl text-[#969696]">Unleash your creativity with our powerful image editing tools</p>
      </div>

      <div class="bg-[#0f1629] p-8 rounded-3xl shadow-xl w-full max-w-md">
        <div class="flex items-center justify-center mb-6">
          <CameraIcon class="w-12 h-12 text-[#6D28D9]" />
          <span class="text-2xl font-bold ml-2 bg-gradient-to-r from-[#6D28D9] to-white bg-clip-text text-transparent tracking-tight">PictuRAS</span>
        </div>
      ...
      <div class="mt-8 text-center">
        <blockquote class="text-lg italic text-[#969696]">
          "PictuRAS revolutionized how I edit images. It's easy to use and packed with powerful features."
        </blockquote>
